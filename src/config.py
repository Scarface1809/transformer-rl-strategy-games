...
class TrainingConfig:
    # MCTS
    mcts_sims: int = 1024             # More simulations = slower but better TODO: 1600 increase
    ...
    num_train_epochs: int = 10        # How many epochs per buffer sample
    buffer_size: int = 10000          # Max transitions in buffer (also used for plotting)
    frequency_games: int = 100        # Train after every N self-play games #TODO Do 100 games or 200 not sure
    epochs: int = 5000               # Total training epochs (games) # TODO: Less epoches maybe?
